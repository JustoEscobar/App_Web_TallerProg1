<div>
	<img class="responsiva" src="assets/img/principal/fondo1.jpg">
</div>
    ...
    <section class="alturita">
          <?php if (!$productos) { ?>
            <div class="container altura">
              <div>
                <h2 class="text-center">No hay Planes Alimentarios disponibles</h2>
              </div>  
            </div>
          <?php 
          } else { ?>
        <div class="container mb-5 mt-5">
          <div class="text-left"><h5><b>CATÁLOGO DE PLANES ALIMENTARIOS</b></h5></div>
                ...
                <div class="text-center">
                  <?php 
                    if (($row->stock > 0) && ($session_data = $this->session->userdata('logged_in'))) {
                      ...
                      echo form_submit('submit','AÑADIR AL CARRITO',"class='p-3 promo mt-2 btn-dark btn-block cursor1'");
                      echo form_close();
                      }
                  ?>
                </div>
